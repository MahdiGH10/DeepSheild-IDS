...
def _html_banner_and_card_open(p: dict) -> str:
    ...
    return f"""
      <div style="background:#0a1628;border-left:4px solid #ff3e6c;padding:14px 18px;border-radius:10px 10px 0 0;">
        <div style="font-family:Consolas,Menlo,Monaco,monospace;color:#00ffe7;font-size:18px;font-weight:700;">Deepshield IDS</div>
...
def build_comprehensive_incident_package_pdf(report_payload: dict) -> bytes:
    ...
    class _ProDoc(FPDF):
        ...
        def footer(self) -> None:
            ...
            self.cell(0, 4, _pdf_safe("Auto-generated by Deepshield IDS | For urgent escalation contact your SOC"), align="C")
    ...
    header_rows = [
        ("Deepshield IDS", "INCIDENT REPORT", (3, 12, 22), (3, 12, 22), (0, 200, 255), (0, 200, 255), (11, 11), ("Helvetica", "B", 11), ("Helvetica", "B", 11)),
